...
namespace DVG.WIS.Core
{
    public class Const
    {
        ...
        public const string SessionCart = "SessionCart"; // danh-gia-xe-may
        ...
        public const string DomainTrackingView = "DomainTrackingView";
        ...
        //public const int PageSizeCarAssessment = 12;
        public const int PortalTopContract = 2;

        public const string PageSizeCarAssessment = "PageSizeCarAssessment";
        ...
        public const string SessionFirstLoginUsername = "SessionFirstLoginUsername";
        ...
        public const string UsingOTP = "UsingOTP";
