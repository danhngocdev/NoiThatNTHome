...
namespace DVG.WIS.Core
{
    public class ConstKeyCached
    {
        ...
        public const string GetNewsTimeline = "GetNewsTimeline";
        ...
        public const string GetListSuggest = "GetListSuggest";
        ...
        #region Street
        public const string StreetListAll = "StreetListAll";
        #endregion

        #region sitemap

        public const string GenSiteMapCategory = "SiteMapCategory";
        public const string GenSiteMapIndex = "SiteMapIndex";
        public const string GenSiteMapNews = "SiteMapNews";
