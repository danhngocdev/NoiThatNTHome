...
namespace DVG.WIS.Utilities.Google.AMP
{
    public class AmpUtility
    {
        public static string GenerateHtmlContent(string content, string domain = "", string domainMobile = "")
        {
            ...
            {
                content = Regex.Replace(content, string.Concat("//", domain), string.Concat("//", domainMobile));
            }
