...
namespace DVG.WIS.Utilities
{
    public abstract class ContextBase
    {
        ...
        protected string _language = CookieManager.Instance.Get<string>(CookieManager.PublicKeyLanguage);
        ...
        protected string GetConnectionString(DBPosition dbPosition, string defaultConnectionName = "ConnectionString")
        {
            ...
            if(!string.IsNullOrEmpty(_language)) connectionName = string.Concat(connectionName, "_", _language);
