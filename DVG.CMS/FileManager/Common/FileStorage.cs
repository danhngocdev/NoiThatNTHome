...
namespace FileManager.Common
{
    public class FileStorage
    {
        ...
        public static string SendRequestWithParram(string url, NameValueCollection nvc)
        {
            try
            {
                ...
                catch (Exception ex)
                {
                    ...
                    // DVG.WIS.// LogES.LogES.Instance.LogException(DVG.WIS.LogES.Models.LogSourceTypeEnums.CMS, DVG.WIS.LogES.Models.LogErrorSeverityEnums.Error, ex, url, nvc);
                    if (wresp != null)
                    {
                        wresp.Close();
                        wresp = null;
        ...
        public static string HttpUploadFile(string url, HttpPostedFile file, string paramName, string contentType, NameValueCollection nvc)
        {
            ...
            {
                Logger.WriteLog(Logger.LogType.Error, ex.ToString());
                // DVG.WIS.// LogES.LogES.Instance.LogException(DVG.WIS.LogES.Models.LogSourceTypeEnums.CMS, DVG.WIS.LogES.Models.LogErrorSeverityEnums.Error, ex, url, paramName, contentType, nvc);
                if (wresp != null)
                {
                    wresp.Close();
                    wresp = null;
