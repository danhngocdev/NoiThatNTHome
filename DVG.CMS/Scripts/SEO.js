...
function ValidateKeyword() {
	...
	var cat_unsign = UnicodeToUnsignAndSlash($('#category option:selected').text());
	if (cat_unsign == null || cat_unsign == '') cat_unsign = 'chuyen-muc-test';
	var link = BaseUrl + cat_unsign + '/' + newsid + '/' + UnicodeToUnsignAndSlash(title);
	$('#ggLink').html(link);
