...
function layoutToggleDirective($interval) {
    ...
    function link(scope, element, attrs) {
        element.on('click', function () {
            ...
            if (element.hasClass('aside-edit-panel-toggler')) {
                angular.element('body').toggleClass('aside-edit-panel-hidden');
            }
        });
    }
}
...
function openAsidePanel(size) {
    switch (size) {
        case 'sm':
            if (angular.element('body').hasClass("aside-edit-panel-hidden")) {
                angular.element('body').toggleClass('aside-edit-panel-hidden').addClass("aside-edit-panel-fixed-sm");
            }
        default:
            if (angular.element('body').hasClass("aside-edit-panel-hidden")) {
                angular.element('body').toggleClass('aside-edit-panel-hidden').removeClass("aside-edit-panel-fixed-sm");
            }
    }
}
function closeAsidePanel(size) {
    switch (size) {
        case 'sm':
            if (!angular.element('body').hasClass("aside-edit-panel-hidden")) {
                angular.element('body').toggleClass('aside-edit-panel-hidden').addClass("aside-edit-panel-fixed-sm");
