...
namespace DVG.WIS.Image.App_Start
{
    public class ImageRouteHandler : IRouteHandler
    {
        public IHttpHandler GetHttpHandler(RequestContext requestContext)
        {
            string pathnoimage = requestContext.HttpContext.Server.MapPath("~/images/noimage.png");
            ...
            string pathNew = AppSettings.Instance.GetString("PathNewReplace");
            path = path.Replace("images", pathNew);
